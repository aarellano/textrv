  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved system as @system" do
        ...
        post :create, {:system => { "name" => "invalid value" }}, valid_session
        expect(assigns(:system)).to be_a_new(System)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested system" do
        ...
        expect_any_instance_of(System).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => system.to_param, :system => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the system as @system" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        System.any_instance.stub(:save).and_return(false)
        put :update, {:id => system.to_param, :system => { "name" => "invalid value" }}, valid_session
        expect(assigns(:system)).to eq(system)
      end
